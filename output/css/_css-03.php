...
.twss_6310_team_style_<?php echo $ids ?> .twss_6310_team_style_<?php echo $ids ?>_img img.twss_hover_image {
...
.twss_6310_team_style_<?php echo $ids ?>:hover {
  ...
  box-shadow: 0 0 <?php echo ($cssData['box_shadow_blur'] * 2) ?>px <?php echo $cssData['twss_hover_box_shadow_color'] ?>;
}
.twss_6310_team_style_<?php echo $ids ?>_title {
  text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.1);
  font-size: <?php echo $cssData['member_font_size'] ?>px;
