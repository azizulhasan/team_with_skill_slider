...
.twss-6310-owl-stage div:nth-child(1n+<?php echo $cssData['item_per_row'] ?>) div div.twss_6310_team_style_<?php echo $ids; ?>
{
  background: linear-gradient(to top, <?php echo $cssData['box_background_first_color'] ?> 80%, transparent 20%) !important;
}
...
.twss-6310-owl-stage div.twss-6310-owl-item:nth-child(2) .twss-6310-item-<?php echo $ids;?> .twss_6310_team_style_<?php echo $ids; ?> 
{
  background: linear-gradient(to top, <?php echo $cssData['box_background_second_color'] ?> 80%, transparent 20%) !important;
}
...
.twss-6310-owl-stage div.twss-6310-owl-item:nth-child(3) .twss-6310-item-<?php echo $ids;?> .twss_6310_team_style_<?php echo $ids; ?> 
{
  background: linear-gradient(to top, <?php echo $cssData['box_background_third_color'] ?> 80%, transparent 20%)!important;
...
.twss-6310-owl-stage div.twss-6310-owl-item:nth-child(4) .twss-6310-item-<?php echo $ids;?> .twss_6310_team_style_<?php echo $ids; ?> 
{
  background: linear-gradient(to top, <?php echo $cssData['box_background_fourth_color'] ?> 80%, transparent 20%)!important;
...
.twss-6310-owl-stage div.twss-6310-owl-item:nth-child(5) .twss-6310-item-<?php echo $ids;?> .twss_6310_team_style_<?php echo $ids; ?> 

{
  background: linear-gradient(to top, <?php echo $cssData['box_background_five_color'] ?> 80%, transparent 20%)!important;
...
.twss-6310-owl-stage div.twss-6310-owl-item:nth-child(6) .twss-6310-item-<?php echo $ids;?> .twss_6310_team_style_<?php echo $ids; ?> 

{
  background: linear-gradient(to top, <?php echo $cssData['box_background_six_color'] ?> 80%, transparent 20%)!important;
...
.twss-6310-owl-stage .twss-6310-owl-item:nth-child(1n+<?php echo $cssData['item_per_row'] ?>) .twss-6310-item-<?php echo $ids;?> .twss_6310_team_style_<?php echo $ids; ?>:hover
{
  
  background: linear-gradient(to top, <?php echo $cssData['box_background_first_hover_color'] ?> 80%, transparent 20%) !important;
}
...
.twss-6310-owl-stage .twss-6310-owl-item:nth-child(2n+<?php echo $cssData['item_per_row'] ?>) .twss-6310-item-<?php echo $ids;?> .twss_6310_team_style_<?php echo $ids; ?>:hover
{
  background: linear-gradient(to top, <?php echo $cssData['box_background_second_hover_color'] ?> 80%, transparent 20%)!important;
...
.twss-6310-owl-stage .twss-6310-owl-item:nth-child(3n+<?php echo $cssData['item_per_row'] ?>) .twss-6310-item-<?php echo $ids;?> .twss_6310_team_style_<?php echo $ids; ?>:hover
{
  background: linear-gradient(to top, <?php echo $cssData['box_background_third_hover_color'] ?> 80%, transparent 20%)!important;
...
.twss-6310-owl-stage .twss-6310-owl-item:nth-child(4n+<?php echo $cssData['item_per_row'] ?>) .twss-6310-item-<?php echo $ids;?> .twss_6310_team_style_<?php echo $ids; ?>:hover
{
  background: linear-gradient(to top, <?php echo $cssData['box_background_fourth_hover_color'] ?> 80%, transparent 20%)!important;
}
...
.twss-6310-owl-stage .twss-6310-owl-item:nth-child(5n+<?php echo $cssData['item_per_row'] ?>) .twss-6310-item-<?php echo $ids;?> .twss_6310_team_style_<?php echo $ids; ?>:hover
{
  background: linear-gradient(to top, <?php echo $cssData['box_background_five_hover_color'] ?> 80%, transparent 20%) !important;
}
...
.twss-6310-owl-stage .twss-6310-owl-item:nth-child(6n+<?php echo $cssData['item_per_row'] ?>) .twss-6310-item-<?php echo $ids;?> .twss_6310_team_style_<?php echo $ids; ?>:hover
{
  background: linear-gradient(to top, <?php echo $cssData['box_background_six_hover_color'] ?> 80%, transparent 20%)!important;
