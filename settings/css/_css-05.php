<style type="text/css">
   ...
   .twss_6310_team_style_05_title {
     ...
     bottom: <?php echo ($cssData['designation_line_height'] + 25) ?>px;
   ...
   .twss_6310_team_style_05_designation {
     ...
     font-size: <?php echo $cssData['designation_font_size'] ?>;
  ...
  padding:<?php echo ceil(($cssData['social_icon_width'] + $cssData['social_icon_height']) / 8) ?>px;
   ...
   div.twss_6310_team_style_05_contact div:last-child {
     border-bottom: none;
   }
