        ...
        <h3 class="twss-tab-menu-settings">Name Settings</h3>
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr height="45">
                <td width='55%'><b>Title Align</b><?php //twss_pro()?></td>
                <td>
              ...
              <tr height="45">
                <td width='55%'><b>title padding</b><?php //twss_pro()?></td>
                 <td>
        ...
        <h3 class="twss-tab-menu-settings">Designation Settings</h3>
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr height="45">
                <td width='55%'><b>Designation Align</b><?php //twss_pro()?></td>
                <td>
              ...
              <tr height="45">
                <td width='55%'><b>Designation padding</b><?php //twss_pro()?></td>
                 <td>
