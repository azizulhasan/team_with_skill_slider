          ...
          <div class="twss-col-6">
            <table width="100%">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_img_border_color" id="twss_box_img_border_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_img_border_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Image Hover Border Corlor</b></td>
                <td>
                  <input type="text" name="box_img_hover_border_color" id="twss_box_img_hover_border_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['box_img_hover_border_color'] ?>">
                </td>
              </tr>
      ...
      <div id="tab-3">
        ...
        <h3 class="twss-tab-menu-settings">Designation Settings</h3>
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              <tr height="45">
                <td><b>Designation Border Color</b></td>
                <td>
              ...
              <tr height="45">
                <td><b>Designation Border Hover Color</b></td>
                <td>
                  <input type="text" name="designation_border_hover_color" id="twss_designation_border_hover_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['designation_border_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Designation Border After Color</b></td>
                <td>
                  <input type="text" name="designation_border_after_color" id="twss_designation_border_after_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['designation_border_after_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                <td><b>Designation Border After Hover Color</b></td>
                <td>
                  <input type="text" name="designation_border_after_hover_color" id="twss_designation_border_after_hover_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['designation_border_after_hover_color'] ?>">
                </td>
              </tr>
      ...
      <div id="tab-5">
        ...
        <h3 class="twss-tab-menu-settings">Social Icon Settings</h3>
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
            <tr height="45">
                <td width='55%'><b>Icon Align</b><?php //twss_pro()?></td>
                <td>
