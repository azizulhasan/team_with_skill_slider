        ...
        <div class="row twss_6310_padding_15_px">
          ...
          <div class="twss-col-6">
            <table width="100%">
              ...
              <tr height="45">
                <td><b>Box Background First</b></td>
                <td>
              ...
              <tr height="45">
                <td><b>Box  Background Second</b></td>
                <td>
              ...
              <tr height="45">
                <td><b>Box  Background Third</b></td>
                <td>
              ...
              <tr height="45">
                <td><b>Box  Background Fourth</b></td>
                <td>
              ...
              <tr height="45">
                <td><b>Box  Background Fifth</b></td>
                <td>
              ...
              <tr height="45">
                <td><b>Box  Background Sixth</b></td>
                <td>
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr height="45">
                <td width="55%"><b>Box Hover First Background</b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box Hover Second Background</b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box Hover Third Background</b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box Hover Fourth Background</b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box Hover Fifth Background</b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box Hover Six Background</b><?php //twss_pro()
                                                              ?></td>
                <td>
        ...
        <h3 class="twss-tab-menu-settings">Name Settings</h3>
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr height="45">
                <td><b>Backbround Color</b></td>
                <td>
                  <input type="text" name="member_background_color" id="twss_member_background_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['member_background_color'] ?>">
                </td>
              </tr>

              <tr height="45">
                <td><b>Backbround Hover Color</b></td>
                <td>
                  <input type="text" name="member_background_hover_color" id="twss_member_background_hover_color" class="twss-form-input twss_6310_color_picker" data-format="rgb" value="<?php echo $cssData['member_background_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
