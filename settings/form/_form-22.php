        ...
        <div class="row twss_6310_padding_15_px">
          ...
          <div class="twss-col-6">
            <table width="100%">
              ...
              <tr height="45">
                <td><b>Box Background First Left</b></td>
                <td>
              ...
              <tr height="45">
                <td><b>Box  Background Second Left</b></td>
                <td>
              ...
              <tr height="45">
                <td><b>Box  Background Third Left</b></td>
                <td>
              ...
              <tr height="45">
                <td><b>Box  Background Fourth Left</b></td>
                <td>
              ...
              <tr height="45">
                <td><b>Box  Background Fifth Left</b></td>
                <td>
              ...
              <tr height="45">
                <td><b>Box  Background Sixth Left</b></td>
                <td>
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr height="45">
                <td width="55%"><b>Box  First Background  Right</b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box Second Background Right</b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box  Third Background Right</b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box Fourth Background Right</b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box Fifth Background Right</b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box Six Background Right</b><?php //twss_pro()
                                                              ?></td>
                <td>
