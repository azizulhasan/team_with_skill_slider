        ...
        <div class="row twss_6310_padding_15_px">
          ...
          <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
              ...
              <tr height="45">
                <td width="55%"><b>Box First Background Top </b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box Second Background Top </b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box Third Background Top </b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box Fourth Background Top </b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box Fifth Background Top </b><?php //twss_pro()
                                                              ?></td>
                <td>
              ...
              <tr height="45">
                <td width="55%"><b>Box Six Background Top </b><?php //twss_pro()
                                                              ?></td>
                <td>
