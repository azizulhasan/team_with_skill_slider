        ...
        <div class="twss-col-6">
            <table class="table table-responsive twss_6310_admin_table">
                ...
                <tr height="45">
                    ...
                    <td>
                        <input type="number" min="0" name="details_summary_words" value="<?php echo $cssData['details_summary_words'] ?>" class="twss-form-input" step="1" id="twss_details_summary_words" />
                    </td>
                </tr>
                <tr height="45">
                ...
                <tr height="45" class="read_more_act_field">
                    <td width='55%'><b>Read More Width</b><?php //twss_pro()
                                                                ?></td>
                    <td>
                        <select name="read_more_width" class="twss-form-input" id="twss_read_more_width">
                        <option value="120px" <?php if ($cssData['read_more_width'] == '120px') echo " selected=''" ?>>default</option>
                        <option value="100%" <?php if ($cssData['read_more_width'] == '100%') echo " selected=''" ?>>100%</option>
                        <option value="90%" <?php if ($cssData['read_more_width'] == '90%') echo " selected=''" ?>>90%</option>
                        <option value="80%" <?php if ($cssData['read_more_width'] == '80%') echo " selected=''" ?>>80%</option>
                        <option value="70%" <?php if ($cssData['read_more_width'] == '70%') echo " selected=''" ?>>70%</option>
                        <option value="60%" <?php if ($cssData['read_more_width'] == '60%') echo " selected=''" ?>>60%</option>
                        <option value="50%" <?php if ($cssData['read_more_width'] == '50%') echo " selected=''" ?>>50%</option>
                        </select>
                    </td>
                </tr>
            ...
            <tr height="45" class="read_more_act_field">
                <td width='55%'><b>Read More Border Width</b><?php //twss_pro()
                                                            ?></td>
                <td>
                    <select name="read_more_border_width" class="twss-form-input" id="twss_read_more_border_width">
                    <option value="none" <?php if ($cssData['read_more_border_width'] == 'none') echo " selected=''" ?>>None</option>
                    <option value="1px" <?php if ($cssData['read_more_border_width'] == '1px') echo " selected=''" ?>>1px</option>
                    <option value="2px" <?php if ($cssData['read_more_border_width'] == '2px') echo " selected=''" ?>>2px</option>
                    <option value="3px" <?php if ($cssData['read_more_border_width'] == '3px') echo " selected=''" ?>>3px</option>
                    <option value="4px" <?php if ($cssData['read_more_border_width'] == '4px') echo " selected=''" ?>>4px</option>
                    <option value="5px" <?php if ($cssData['read_more_border_width'] == '5px') echo " selected=''" ?>>5px</option>
                    </select>
                </td>
            </tr>
                <tr height="45" class="read_more_act_field">
            ...
            <table class="table table-responsive twss_6310_admin_table">
                <tr height="45">
                    ...
                    <td>
                        <select name="details_font_weight" class="twss-form-input" id="twss_details_font_weight">
                            <option value="100" <?php if ($cssData['details_font_weight'] == '100') echo " selected=''" ?>>100</option>
                            <option value="200" <?php if ($cssData['details_font_weight'] == '200') echo " selected=''" ?>>200</option>
                            <option value="300" <?php if ($cssData['details_font_weight'] == '300') echo " selected=''" ?>>300</option>
                            <option value="400" <?php if ($cssData['details_font_weight'] == '400') echo " selected=''" ?>>400</option>
                            <option value="500" <?php if ($cssData['details_font_weight'] == '500') echo " selected=''" ?>>500</option>
                            <option value="600" <?php if ($cssData['details_font_weight'] == '600') echo " selected=''" ?>>600</option>
                            <option value="700" <?php if ($cssData['details_font_weight'] == '700') echo " selected=''" ?>>700</option>
                            <option value="800" <?php if ($cssData['details_font_weight'] == '800') echo " selected=''" ?>>800</option>
                            <option value="900" <?php if ($cssData['details_font_weight'] == '900') echo " selected=''" ?>>900</option>
                            <option value="normal" <?php if ($cssData['details_font_weight'] == 'normal') echo " selected=''" ?>>Normal</option>
                            <option value="bold" <?php if ($cssData['details_font_weight'] == 'bold') echo " selected=''" ?>>Bold</option>
                            <option value="lighter" <?php if ($cssData['details_font_weight'] == 'lighter') echo " selected=''" ?>>Lighter</option>
                            <option value="initial" <?php if ($cssData['details_font_weight'] == 'initial') echo " selected=''" ?>>Initial</option>
                        </select>
                    </td>
                </tr>
                <tr height="45">
                    ...
                    <td>
                        <select name="details_text_transform" class="twss-form-input" id="twss_details_text_transform">
                            ...
                            <option value="none" <?php if ($cssData['details_text_transform'] == 'none') echo " selected=''" ?>>As Input</option>
                        </select>
                    </td>
                </tr>
                <tr height="45">
                    <td width='55%'><b>Text Align</b><?php //twss_pro()
                                                        ?></td>
                    <td>
                        <select name="details_text_align" class="twss-form-input" id="twss_details_text_align">
                            <option value="center" <?php if ($cssData['details_text_align'] == 'center') echo " selected=''" ?>>Center</option>
                            <option value="left" <?php if ($cssData['details_text_align'] == 'left') echo " selected=''" ?>>Left</option>
                            <option value="right" <?php if ($cssData['details_text_align'] == 'right') echo " selected=''" ?>>Right</option>
                            <option value="justify" <?php if ($cssData['details_text_align'] == 'justify') echo " selected=''" ?>>Justify</option>
                        </select>
                    </td>
                </tr>
                <tr height="45">
             ...
             <tr>
                ...
                <tr height="45" class="read_more_act_field">
                 ...
                 <tr height="45" class="read_more_act_field">
                    <td ><b>Read More Font Weight</b><?php //twss_pro()
                                                        ?></td>
                    <td>
                        <select name="read_more_font_weight" class="twss-form-input" id="twss_read_more_font_weight">
                            <option value="100" <?php if ($cssData['read_more_font_weight'] == '100') echo " selected=''" ?>>100</option>
                            <option value="200" <?php if ($cssData['read_more_font_weight'] == '200') echo " selected=''" ?>>200</option>
                            <option value="300" <?php if ($cssData['read_more_font_weight'] == '300') echo " selected=''" ?>>300</option>
                            <option value="400" <?php if ($cssData['read_more_font_weight'] == '400') echo " selected=''" ?>>400</option>
                            <option value="500" <?php if ($cssData['read_more_font_weight'] == '500') echo " selected=''" ?>>500</option>
                            <option value="600" <?php if ($cssData['read_more_font_weight'] == '600') echo " selected=''" ?>>600</option>
                            <option value="700" <?php if ($cssData['read_more_font_weight'] == '700') echo " selected=''" ?>>700</option>
                            <option value="800" <?php if ($cssData['read_more_font_weight'] == '800') echo " selected=''" ?>>800</option>
                            <option value="900" <?php if ($cssData['read_more_font_weight'] == '900') echo " selected=''" ?>>900</option>
                            <option value="normal" <?php if ($cssData['read_more_font_weight'] == 'normal') echo " selected=''" ?>>Normal</option>
                            <option value="bold" <?php if ($cssData['read_more_font_weight'] == 'bold') echo " selected=''" ?>>Bold</option>
                            <option value="lighter" <?php if ($cssData['read_more_font_weight'] == 'lighter') echo " selected=''" ?>>Lighter</option>
                            <option value="initial" <?php if ($cssData['read_more_font_weight'] == 'initial') echo " selected=''" ?>>Initial</option>
                        </select>
                    </td>
                </tr>
                <tr height="45" class="read_more_act_field">
                    <td ><b>Read More Text Transform</b><?php //twss_pro()
                                                            ?></td>
                    <td>
                        <select name="read_more_text_transform" class="twss-form-input" id="twss_read_more_text_transform">
                            <option value="capitalize" <?php if ($cssData['read_more_text_transform'] == 'capitalize') echo " selected=''" ?>>Capitalize</option>
                            ...
                            <option value="none" <?php if ($cssData['read_more_text_transform'] == 'none') echo " selected=''" ?>>As Input</option>
                        </select>
                    </td>
                </tr>
                <tr height="45" class="read_more_act_field">
                    <td ><b>Read More Text Align</b><?php //twss_pro()
                                                        ?></td>
                    <td>
                        <select name="read_more_text_align" class="twss-form-input" id="twss_read_more_text_align">
                            <option value="center" <?php if ($cssData['read_more_text_align'] == 'center') echo " selected=''" ?>>Center</option>
                            <option value="left" <?php if ($cssData['read_more_text_align'] == 'left') echo " selected=''" ?>>Left</option>
                            <option value="right" <?php if ($cssData['read_more_text_align'] == 'right') echo " selected=''" ?>>Right</option>
                            
                        </select>
                    </td>
                </tr>
                <tr height="45" class="read_more_act_field">
                    <td><b>Read More Font Family</b><?php //twss_pro()
                                            ?></td>
...
<style>
    #hr{width:100%; background:#0073AA; height:0; border:2px solid #0073AA;margin:10px 0;}
</style>