...
<div id="tab-8">
   <div class="row twss_6310_padding_15_px">
      ...
      <div class="twss-col-6">
         ...
         <table width="100%" class="twss_6310_carousel_field">
            <tr height="45">
               <td width="45%"><b>Effect Duration</b></td>
               <td>
            ...
            <tr height="45" class="twss_6310_prev_next_act">
               <td>
         ...
         <table width="100%" class="twss_6310_category_field">
            <tr>
               <td width="45%"><b>Font Size</b></td>
               <td width="55%">
                  <input type="text" name="category_font_size" id="twss_6310_category_font_size" value="<?php echo $cssData['category_font_size'] ?>">
               </td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td width="55%">
                  <input type="text" name="category_border_width" id="twss_6310_category_border_width" value="<?php echo $cssData['category_border_width'] ?>">
               </td>
            </tr>
            <tr>
      ...
      <div class="twss-col-6">
         <table width="100%" class="twss_6310_carousel_field">
            ...
            <tr height="45" class="twss_6310_indicator_act">
               <td>
                  <b>Indicator Width</b>
               </td>
               <td>
         ...
         <table width="100%" class="twss_6310_category_field">
            ...
            <tr>
               ...
               <td width="55%">
                  <input type="text" name="category_margin_bottom" id="twss_6310_category_margin_bottom" value="<?php echo $cssData['category_margin_bottom'] ?>">
               </td>
            </tr>
            <tr>
               <td width="45%"><b>Menu Height</b></td>
               <td width="55%">
                  <input type="text" name="category_menu_height" id="twss_6310_category_menu_height" value="<?php echo $cssData['category_menu_height'] ?>">
               </td>
            </tr>
            <tr>
               <td width="45%"><b>Margin Right</b></td>
               <td width="55%">
                  <input type="text" name="category_margin_right" id="twss_6310_category_margin_right" value="<?php echo $cssData['category_margin_right'] ?>">
               </td>
            </tr>
            <tr>
               <td width="45%"><b>Padding Right Left</b></td>
               <td width="55%">
                  <input type="text" name="category_padding_right_left" id="twss_6310_category_padding_right_left" value="<?php echo $cssData['category_padding_right_left'] ?>">
               </td>
            </tr>
         </table>
      </div>
...
<script>
   ...
   jQuery(document).ready(function() {
      ...
      if ($cssData['twss_fun_template_slider'] == 1) {
         echo "jQuery('#twss-6310-noslider-{$styleId}, #twss-6310-category-filter-{$styleId}, .twss_6310_category_field').hide();";
         echo "jQuery('#twss-6310-slider-{$styleId}, .twss_6310_carousel_field').show();";
      } else if ($cssData['twss_fun_template_slider'] == 2) {
         echo "jQuery('#twss-6310-noslider-{$styleId}, #twss-6310-slider-{$styleId}, .twss_6310_carousel_field').hide();";
         echo "jQuery('#twss-6310-category-filter-{$styleId}, .twss_6310_category_field').show();";
      } else {
         echo "jQuery('#twss-6310-slider-{$styleId}, #twss-6310-category-filter-{$styleId}, .twss_6310_carousel_field, .twss_6310_category_field').hide();";
      ...
      jQuery("body").on("change", "#twss_fun_template_slider", function() {
         ...
         if (val == 0) {
            ...
            jQuery(".twss_6310_category_field, .twss_6310_carousel_field, #twss-6310-slider-<?php echo $styleId ?>, #twss-6310-category-filter-<?php echo $styleId ?>").hide();
         } else if (val == 2) {
            jQuery(".twss_6310_category_field, #twss-6310-category-filter-<?php echo $styleId ?>").show();
            jQuery(".twss_6310_carousel_field, #twss-6310-slider-<?php echo $styleId ?>, #twss-6310-noslider-<?php echo $styleId ?>").hide();
         } else {
            jQuery(".twss_6310_carousel_field, #twss-6310-slider-<?php echo $styleId ?>").show();
            jQuery(".twss_6310_category_field, #twss-6310-noslider-<?php echo $styleId ?>, #twss-6310-category-filter-<?php echo $styleId ?>").hide();
         }
      });
      ...
      jQuery("body").on("change", "input[name='category_font_size']", function() {
         ...
         jQuery("<style type='text/css'>.twss_6310_category .twss_6310_category_list-<?php echo $styleId ?>{ font-size:" + parseInt(jQuery(this).val()) + "px;} </style>").appendTo(".twss_6310_tabs_panel_preview");
      });
      jQuery("body").on("change", "input[name='category_font_color']", function() {
         jQuery("<style type='text/css'>.twss_6310_category .twss_6310_category_list-<?php echo $styleId ?>{ color:" + jQuery(this).val() + ";} </style>").appendTo(".twss_6310_tabs_panel_preview");
      });

      jQuery("body").on("change", "input[name='category_font_hover_color']", function() {
         jQuery("<style type='text/css'>.twss_6310_category .twss_6310_category_list-<?php echo $styleId ?>:hover{ color:" + jQuery(this).val() + ";} </style>").appendTo(".twss_6310_tabs_panel_preview");
      });

      jQuery("body").on("change", "#twss_6310_category_border_color, #twss_6310_category_border_width", function() {
         jQuery("<style type='text/css'>.twss_6310_category .twss_6310_category_list-<?php echo $styleId ?>{ border:" + jQuery("#twss_6310_category_border_width").val() + "px solid " + jQuery("#twss_6310_category_border_color").val() + ";} </style>").appendTo(".twss_6310_tabs_panel_preview");
      });
      jQuery("body").on("change", "input[name='category_background_color']", function() {
         jQuery("<style type='text/css'>.twss_6310_category .twss_6310_category_list-<?php echo $styleId ?>{ background-color:" + jQuery(this).val() + ";} </style>").appendTo(".twss_6310_tabs_panel_preview");
      });
      ...
      jQuery("body").on("change", "#twss_6310_category_font_weight", function() {
         jQuery("<style type='text/css'>.twss_6310_category .twss_6310_category_list-<?php echo $styleId ?>{ font-weight:" + jQuery(this).val() + ";} </style>").appendTo(".twss_6310_tabs_panel_preview");
      });
      jQuery("body").on("change", "input[name='category_font_family']", function() {
         jQuery("<style type='text/css'>.twss_6310_category .twss_6310_category_list-<?php echo $styleId ?>{ font-family:" + jQuery(this).val() + ";} </style>").appendTo(".twss_6310_tabs_panel_preview");
      });
      jQuery("body").on("change", "input[name='category_margin_bottom']", function() {
         jQuery("<style type='text/css'>.twss_6310_category{ margin-bottom:" + parseInt(jQuery(this).val()) + "px;} </style>").appendTo(".twss_6310_tabs_panel_preview");
      });
      jQuery("body").on("change", "input[name='category_menu_height']", function() {
         jQuery("<style type='text/css'> .twss_6310_category{ height:" + parseInt(jQuery(this).val()) + "px; line-height:" + parseInt(jQuery(this).val()) + "px;} </style>").appendTo(".twss_6310_tabs_panel_preview");
      });

      jQuery("body").on("change", "#twss_6310_category_margin_right", function() {
         jQuery("<style type='text/css'> .twss_6310_category .twss_6310_category_list{ margin-right:" + parseInt(jQuery(this).val()) + "px;} </style>").appendTo(".twss_6310_tabs_panel_preview");
      });
      jQuery("body").on("change", "input[name='category_padding_right_left']", function() {
         jQuery("<style type='text/css'>.twss_6310_category .twss_6310_category_list{ padding-right:" + parseInt(jQuery(this).val()) + "px;padding-left:" + parseInt(jQuery(this).val()) + "px;} </style>").appendTo(".twss_6310_tabs_panel_preview");
      });
      jQuery("body").on("change", "#twss_6310_category_active_background_color", function() {
         jQuery("<style type='text/css'>.twss_6310_category .twss_6310_category_list_active{ background-color:" + jQuery(this).val() + "!important;} </style>").appendTo(".twss_6310_tabs_panel_preview");
      });

      jQuery("body").on("change", "#twss_6310_category_active_font_color", function() {
         jQuery("<style type='text/css'>.twss_6310_category .twss_6310_category_list_active{ color:" + jQuery(this).val() + "!important;} </style>").appendTo(".twss_6310_tabs_panel_preview");
      });

      jQuery("body").on("change", "#twss_6310_category_active_border_color", function() {
         jQuery("<style type='text/css'>.twss_6310_category .twss_6310_category_list_active{ border-color:" + jQuery(this).val() + "!important;} </style>").appendTo(".twss_6310_tabs_panel_preview");
      });
...
<style>
   ...
   .twss_6310_category .twss_6310_category_list {
   ...
   .twss_6310_category .twss_6310_category_list:hover {
      color: <?php echo $cssData['category_font_hover_color'] ?>;
   }

   .twss_6310_category_list_active {
...
<script>
   jQuery(document).ready(function() {
      ...
      jQuery("body").on("click", ".twss_6310_category_list", function() {
         ...
         if (attr != 'all') {
            jQuery('#twss-6310-category-filter-<?php echo $styleId ?>')
