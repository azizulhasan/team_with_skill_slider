<div class="twss-6310">
   <div class="twss-6310-sm">
      ...
      <div class="twss-plugin-setting-left">
         ...
         // print_r($cssData);
         // echo "</pre>";
         include twss_6310_plugin_url . 'settings/form/_form-01.php';
         include twss_6310_plugin_url . 'settings/css/_css-01.php';
         include twss_6310_plugin_url . 'settings/helper/template-01.php';
         include twss_6310_plugin_url . 'settings/helper/slider_helper.php';
         twss_6310_skills_css($cssData, "01");
         twss_6310_skills_script($cssData, "01");
         twss_fun_template_read_more_style($cssData, '01');
         twss_fun_template_read_more_script($cssData, '01');
         ?>
            ...
            <div id="twss-6310-noslider-<?php echo $styleId ?>">
               ...
               ?>
                     <div class="twss-6310-col-<?php echo $cssData['item_per_row'] ?>">
                        <div class="<?php echo "twss_6310_team_style_01" ?>">
                           <div class="twss_6310_team_style_01_img twss_6310_image_hover_effect ">
                              ...
                              <div class="twss_6310_team_style_01_caption">
                                 ...
                                 foreach ($template_order as $td) {
                                    if ($td == 'twss_fun_template_name') {
                                       ...
                                       twss_fun_template_designation($value['designation'], $styleId, '01');
