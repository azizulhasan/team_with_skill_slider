<div class="twss-6310">
  <div class="twss-6310-sm">
    ...
    <div class="twss-plugin-setting-left">
      ...
      // print_r($cssData);
      // echo "</pre>";
      include twss_6310_plugin_url . 'settings/form/_form-13.php';
      include twss_6310_plugin_url . 'settings/css/_css-13.php';
      include twss_6310_plugin_url . 'settings/helper/template-13.php';
      include twss_6310_plugin_url . 'settings/helper/slider_helper.php';
      twss_6310_skills_css($cssData, '13');
      twss_6310_skills_script($cssData, '13');
      twss_fun_template_read_more_style($cssData, '13');
      twss_fun_template_read_more_script($cssData, '13');
      ?>
              ...
              foreach ($members as $value) {
                ...
                <div class="twss-6310-col-<?php echo $cssData['item_per_row'] ?>">
                  <div class="twss_6310_team_style_13">
                   <div class="twss_6310_team_style_13_img twss_6310_image_hover_effect">
                  ...
                  <div class="twss_6310_team_style_13_caption">
                    ...
                    foreach ($template_order as $td) {
                      if ($td == 'twss_fun_template_name') {
                        ...
                        twss_fun_template_designation($value['designation'], $styleId, '13');
                      }
                      if ($td == 'twss_fun_template_profile_details') {
                       ...
                       twss_fun_template_skills($value['skills'],'13', $cssData, $value);
                      }
                    }
