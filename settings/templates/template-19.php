<div class="twss-6310">
  <div class="twss-6310-sm">
    ...
    <div class="twss-plugin-setting-left">
      ...
      include twss_6310_plugin_url . 'settings/form/_form-19.php';
      include twss_6310_plugin_url . 'settings/css/_css-19.php';
      include twss_6310_plugin_url . 'settings/helper/template-19.php';
      include twss_6310_plugin_url . 'settings/helper/slider_helper.php';
      twss_6310_skills_css($cssData, '19');
      twss_6310_skills_script($cssData, '19');
      twss_fun_template_read_more_style($cssData, '19');
      twss_fun_template_read_more_script($cssData, '19');
      ?>
                      ...
                      <div class="twss_6310_team_style_19_caption">
                        ...
                        foreach ($template_order as $td) {
                          if ($td == 'twss_fun_template_designation') {
                            twss_fun_template_designation($value['designation'], $styleId, '19');
                          ...
                          twss_fun_template_skills($value['skills'],'19', $cssData, $value);
                        }
                      }
