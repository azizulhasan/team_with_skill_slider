<div class="twss-6310">
  <div class="twss-6310-sm">
    ...
    <div class="twss-plugin-setting-left">
      ...
      include twss_6310_plugin_url . 'settings/form/_form-20.php';
      include twss_6310_plugin_url . 'settings/css/_css-20.php';
      include twss_6310_plugin_url . 'settings/helper/template-20.php';
      include twss_6310_plugin_url . 'settings/helper/slider_helper.php';
      twss_6310_skills_css($cssData, '20');
      twss_6310_skills_script($cssData, '20');
      twss_fun_template_read_more_style($cssData, '20');
      twss_fun_template_read_more_script($cssData, '20');
      ?>
              ...
              foreach ($members as $value) {
                ...
                <div class="twss_6310_team_style_20">
                    ...
                    foreach ($template_order as $td) {
                     ...
                     ?>
                     <div id="pointer"></div>
                    <div class="twss_6310_team_style_20_img twss_6310_image_hover_effect ">
                          ...
                          <?php 
                            foreach ($template_order as $td) {
                              if ($td == 'twss_fun_template_designation') {
                                twss_fun_template_designation($value['designation'], $styleId, '20');
                              }
                            }
                           ?>
                        </div>
                        <figcaption>
                          <div class="twss_6310_team_style_20_caption">
                            ...
                            if ($td == 'twss_fun_template_profile_details') {
                              ...
                              twss_fun_template_skills($value['skills'],'22', $cssData, $value);
                            }
                          }
                      ...
                      <figcaption>
                        <div class="twss_6310_team_style_20_caption">
                          ...
                          if ($td == 'twss_fun_template_profile_details') {
                            ...
                            twss_fun_template_skills($value['skills'],'20', $cssData, $value);
                          }
                        }
                        if ($value['profile_details_type'] > 0) {
                          twss_fun_template_read_more($cssData , '20', $cls, $attr);
