<div class="twss-6310">
  <div class="twss-6310-sm">
    ...
    <div class="twss-plugin-setting-left">
      ...
      include twss_6310_plugin_url . 'settings/form/_form-21.php';
      include twss_6310_plugin_url . 'settings/css/_css-21.php';
      include twss_6310_plugin_url . 'settings/helper/template-21.php';
      include twss_6310_plugin_url . 'settings/helper/slider_helper.php';
      twss_6310_skills_css($cssData, '21');
      twss_6310_skills_script($cssData, '21');
      twss_fun_template_read_more_style($cssData, '21');
      twss_fun_template_read_more_script($cssData, '21');
      ?>
                ...
                ?>
                  <div class="twss-6310-col-<?php echo $cssData['item_per_row'] ?>">
                      ...
                      <div class="twss_6310_team_style_21">
                        <div class="twss_6310_team_style_21_img twss_6310_image_hover_effect ">
                          <div class="hexa">
                            <div class="hex1">
                              <div class="hex2">
                          ...
                          <div class="twss_6310_team_style_21_caption">
                            ...
                            foreach ($template_order as $td) {
                              if ($td == 'twss_fun_template_name') {
                                twss_fun_template_name($value['name'], $styleId, '21');
                                
                              }else if ($td == 'twss_fun_template_designation') {
                                twss_fun_template_designation($value['designation'], $styleId, '21');
                              }else if ($td == 'twss_fun_template_profile_details') {
                                twss_fun_template_profile_details($value, $cssData, $styleId, '21');
                              }else if ($td == 'twss_fun_template_social') {
                                twss_fun_template_social($value, $cssData, $icon_table, $styleId, '21');
                              }else if ($td == 'twss_fun_template_contact') {
                                twss_fun_template_contact($value['contacts'], $cssData, $styleId, '21');
                              } else if ($td == 'twss_fun_template_skills') {
                                twss_fun_template_skills($value['skills'],'21', $cssData, $value);
                              }
                            }
                            if ($value['profile_details_type'] > 0) {
                              twss_fun_template_read_more($cssData , '21', $cls, $attr);
                              }
                            ?>
                          </div>
                        </figcaption>
