<div class="twss-6310">
  <div class="twss-6310-sm">
    ...
    <div class="twss-plugin-setting-left">
      ...
      include twss_6310_plugin_url . 'settings/form/_form-22.php';
      include twss_6310_plugin_url . 'settings/css/_css-22.php';
      include twss_6310_plugin_url . 'settings/helper/template-22.php';
      include twss_6310_plugin_url . 'settings/helper/slider_helper.php';
      twss_6310_skills_css($cssData, '22');
      twss_6310_skills_script($cssData, '22');
      twss_fun_template_read_more_style($cssData, '22');
      twss_fun_template_read_more_script($cssData, '22');
      ?>
              ...
              foreach ($members as $value) {
                ...
                <div class="twss-6310-col-<?php echo $cssData['item_per_row'] ?>">
                  <div class="twss_6310_team_style_22">
                    <div class="twss_6310_team_style_22_img twss_6310_image_hover_effect ">
                        ...
                        <figcaption>
                          <div class="twss_6310_team_style_22_caption">
                            ...
                            if ($td == 'twss_fun_template_name') {
                              twss_fun_template_name($value['name'], $styleId, '22');
                              
                            }else  if ($td == 'twss_fun_template_designation') {
                                twss_fun_template_designation($value['designation'], $styleId, '22');
                            }else if ($td == 'twss_fun_template_profile_details') {
                              twss_fun_template_profile_details($value, $cssData, $styleId, '22');
                            }else if ($td == 'twss_fun_template_social') {
                              twss_fun_template_social($value, $cssData, $icon_table, $styleId, '22');
                            }else if ($td == 'twss_fun_template_contact') {
                              twss_fun_template_contact($value['contacts'], $cssData, $styleId, '22');
                            } else if ($td == 'twss_fun_template_skills') {
                              twss_fun_template_skills($value['skills'],'23', $cssData, $value);
                            }
                          }
                          if ($value['profile_details_type'] > 0) {
                            twss_fun_template_read_more($cssData , '22', $cls, $attr);
                            }
                          ?>
                        </div>
                      </figcaption>
